...
-- Volcando datos para la tabla laplayita.auth_permission: ~24 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.django_content_type: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.django_migrations: ~22 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.lote: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.movimiento_inventario: ~13 rows (aproximadamente)
