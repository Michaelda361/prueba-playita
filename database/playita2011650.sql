...
-- Volcando datos para la tabla laplayita.django_migrations: ~33 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.django_session: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.reabastecimiento: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla laplayita.reabastecimiento_detalle: ~9 rows (aproximadamente)
...
INSERT INTO `usuario` (`id`, `documento`, `nombres`, `apellidos`, `correo`, `telefono`, `contrasena`, `estado`, `fecha_creacion`, `ultimo_login`, `rol_id`, `is_staff`, `is_superuser`) VALUES
	...
	(4, '10000000', 'Laura', 'Gomez', 'laura.admin@laplayita.com', NULL, 'pbkdf2_sha256$1000000$5IUYpFqgilB2EvaR9GQJya$hH7HV5VkSrpqZSxNsg5r9+/o+2BQyzYwWbPiyTDV204=', 'activo', '2025-10-13 19:08:10', '2025-11-20 22:38:40', 1, 0, 0),
